...
boton.addEventListener('click', function () {
    ...
    var conv_json = JSON.stringify(arrayOrder);
    ...
    var maximo = vecesRepetido.reduce(function (a, b) {
        return Math.max(a, b);
    });
    ...
    window.location.href = "http://127.0.0.1:5500/index-pregunta3.html";
    
});

var checkbox1 = document.getElementById('check12')
...
var checkbox2 = document.getElementById('check22')
...
var checkbox3 = document.getElementById('check32')
...
var checkbox4 = document.getElementById('check42')
